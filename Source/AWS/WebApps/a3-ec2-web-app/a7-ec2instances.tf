...
echo '<html><head><title>Taco Team Server 1</title></head><body style=\"background-color:#ABCDEF\"><p style=\"text-align: center;\"><span style=\"color:#FFFFFF;\"><span style=\"font-size:28px; color: orange;\">You did it! Have a &#127790; (Version 3)</span></span></p></body></html>' | sudo tee /usr/share/nginx/html/index.html
EOF
